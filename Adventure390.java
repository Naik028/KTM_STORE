...
public class Adventure390 extends KtmBikes implements Purchase {
	int cost=0;
	...
	String tyre=null;
	int gearbox=0;
	public Adventure390(int cost, double displacement, double mileage, double fuelCapacity, String emission,
			String tyre, int gearbox) {
		super();
		this.cost = cost;
	...
	public void ProcessTransaction(double cashOnHand,double loanAmount) {
		System.out.println("Sir you have selected Adventure390");
